...
fun Animator.addListener(listenerDsl: AnimatorListenerDsl.() -> Unit) {
    this.addListener(AnimatorListenerDsl().apply(listenerDsl))
}

class AnimatorListenerDsl : Animator.AnimatorListener {
    private var onRepeat: ((animation: Animator?) -> Unit)? = null
    private var onEnd: ((animation: Animator?) -> Unit)? = null
    private var onCancel: ((animation: Animator?) -> Unit)? = null
    private var onStart: ((animation: Animator?) -> Unit)? = null
    ...
    fun onRepeat(onRepeat: (animation: Animator?) -> Unit) {
        this.onRepeat = onRepeat
    }

    fun onEnd(onEnd: (animation: Animator?) -> Unit) {
        this.onEnd = onEnd
    }

    fun onCancel(onCancel: (animation: Animator?) -> Unit) {
        this.onCancel = onCancel
    }

    fun onStart(onStart: (animation: Animator?) -> Unit) {
